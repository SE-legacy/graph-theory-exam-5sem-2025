// Определение ниже --- от Perplexity(
== Помечанные деревья

*Помеченное дерево* --- это дерево, вершины которого пронумерованы числами от 1 до n взаимно однозначно.
...
/ Теорема (Формула Кэли): Количество $a_n$ различных помеченных деревьев на $n$
  ...
  *Код Прюфера* или *последовательность Прюфера*:
  ...
  Переводит помеченные деревья порядка $n$ в последовательности чисел по
